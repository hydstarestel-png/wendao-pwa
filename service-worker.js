const CACHE_NAME='wendao-pwa-v19';
const STUDY_TIME_VERSION='20260709-study-time-addon-v1';
const CLARITY_VERSION='20260709-clarity-ledger-v2';
const APP_SHELL=['./','./index.html','./styles.css','./app.js','./cloud-config.js','./cloud-sync.js','./boot-guard.js','./feature-overrides.js','./study-time-overrides.js','./clarity-overrides.js','./feedback-overrides.js','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png','./vendor/tesseract.min.js','./vendor/worker.min.js'];
